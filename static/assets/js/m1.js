  ...
  if (nav) {
    ...
    const html = `
      ...
      <div class="f-nav-right">
        <a class="navbar-link" href="/./"><i class="fa-solid fa-home navbar-icon"></i><an>HOME</an></a>
        ...
        <a class="navbar-link" href="/./c"><i class="fa-solid fa-gear navbar-icon settings-icon"></i><an>SETTING</an></a>
      </div>`;
    nav.innerHTML = html;
  }
